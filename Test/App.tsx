...
import PaymentProcessor, { PaymentProcessorRef } from "payment-challenge";
    ...
    return (
        <View style={styles.container}>
            ...
            <PaymentProcessor
                ...
                onPaymentFailure={(error: Object) =>
                    console.log("Payment failure", error)
                }
                onPaymentCancel={() => console.log("Payment cancelled")}
                onRReqReceived={(rReq: Object) =>
                    console.log("RReq received", rReq)
                }
